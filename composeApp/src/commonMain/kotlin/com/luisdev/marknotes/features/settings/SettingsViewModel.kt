...
//    Account
    private val _accountBottomSheet = MutableStateFlow(false)
    val accountBottomSheet: StateFlow<Boolean> = _accountBottomSheet

    fun setAccountBottomSheet(newValue: Boolean) {
        _accountBottomSheet.value = newValue
    }
}